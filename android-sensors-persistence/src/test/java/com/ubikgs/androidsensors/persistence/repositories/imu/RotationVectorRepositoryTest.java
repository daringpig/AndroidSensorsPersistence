 ...
 */
public class RotationVectorRepositoryTest extends RecordRepositoryTest<RotationVectorRecord, RotationVectorEntity> {

    @Mock
    RotationVectorEntityDao rotationVectorEntityDao;

    @Before
    public void setUp() throws Exception {
        recordEntityDao = rotationVectorEntityDao;
        sensorRecordRepository = new RotationVectorRepository(rotationVectorEntityDao);
    }
    ...
    @Override
    protected RotationVectorEntity createSensorRecordEntity() {
        return new RotationVectorEntity();
    }
