 ...
 */
public class RawGPSStatusRepositoryTest extends RecordRepositoryTest<RawGPSStatusRecord, RawGPSStatusEntity> {
    ...
    public void setUp() throws Exception {
        ...
        sensorRecordRepository = new RawGPSStatusRepository(rawGPSStatusEntityDao);
    }
    ...
    @Override
    protected RawGPSStatusEntity createSensorRecordEntity() {
        return new RawGPSStatusEntity();
    }
