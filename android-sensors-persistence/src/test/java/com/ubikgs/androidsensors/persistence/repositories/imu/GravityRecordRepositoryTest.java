 ...
 */
public class GravityRecordRepositoryTest
        extends SensorRecordRepositoryTest<GravityRecord, GravityRecordEntity> {

    @Mock GravityRecordEntityDao gravityRecordEntityDao;

    @Before
    public void setUp() throws Exception {
        sensorRecordEntityDao = gravityRecordEntityDao;

        sensorRecordRepository = new GravityRecordRepository(gravityRecordEntityDao);
    }
    ...
    @Override
    protected GravityRecordEntity createSensorRecordEntity() {
        return new GravityRecordEntity();
    }
