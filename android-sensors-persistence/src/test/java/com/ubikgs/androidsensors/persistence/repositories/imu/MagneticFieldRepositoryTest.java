 ...
 */
public class MagneticFieldRepositoryTest extends RecordRepositoryTest<MagneticFieldRecord, MagneticFieldEntity> {
    ...
    public void setUp() throws Exception {
        ...
        sensorRecordRepository = new MagneticFieldRepository(magneticFieldEntityDao);
    }
    ...
    @Override
    protected MagneticFieldEntity createSensorRecordEntity() {
        return new MagneticFieldEntity();
    }
