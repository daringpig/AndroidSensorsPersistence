...
public abstract class SensorRecordRepositoryTest<T extends SensorRecord, E extends SensorRecordEntity<T>> {


    protected SensorRecordEntityDao<E> sensorRecordEntityDao;

    protected AbstractSensorRecordRepository<T, E> sensorRecordRepository;

    public void setUp() throws Exception {
        if (sensorRecordEntityDao == null) {
            throw new Error("You must inject an instance of SensorRecordEntityDao in setUp() method");
        }

        if (sensorRecordRepository == null) {
            throw new Error("You must inject an instance of SensorRecordRepository in setUp() method");
        }
    }
    ...
    public void findAll() throws Exception {
        ...
        when(sensorRecordEntityDao.count()).thenReturn(Single.just((long) count));
        when(sensorRecordEntityDao.findAll(0, 1000))
                .thenReturn(Single.just(sensorRecordEntities.subList(0, 1000)));
        when(sensorRecordEntityDao.findAll(1000, 1))
    ...
    public void count() throws Exception {
        ...
        verify(sensorRecordEntityDao, times(1)).count();
    }
    ...
    public void removeAll() throws Exception {
        ...
        verify(sensorRecordEntityDao, times(1)).removeAll();
    }
    ...
    public void findAllByForeignKey() throws Exception {
        ...
        int foreignKey = 0;
        when(sensorRecordEntityDao.countBy(foreignKey)).thenReturn(Single.just((long) count));
        when(sensorRecordEntityDao.findAllBy(foreignKey, 0, 1000))
                .thenReturn(Single.just(sensorRecordEntities.subList(foreignKey, 1000)));
        when(sensorRecordEntityDao.findAllBy(foreignKey,1000, 1))
                .thenReturn(Single.just(sensorRecordEntities.subList(1000, 1001)));
    ...
    public void countByForeignKey() throws Exception {
        ...
        verify(sensorRecordEntityDao, times(1)).countBy(0L);
    }
    ...
    public void removeAllByForeignKey() throws Exception {
        ...
        verify(sensorRecordEntityDao, times(1)).removeAllBy(0L);
    }
