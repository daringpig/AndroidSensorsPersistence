 ...
 */
public class RawGPSMeasurementsRepositoryTest extends RecordRepositoryTest<RawGPSMeasurementsRecord, RawGPSMeasurementsEntity> {
    ...
    public void setUp() throws Exception {
        ...
        sensorRecordRepository = new RawGPSMeasurementsRepository(rawGPSMeasurementsEntityDao);
    }
    ...
    @Override
    protected RawGPSMeasurementsEntity createSensorRecordEntity() {
        return new RawGPSMeasurementsEntity();
    }
