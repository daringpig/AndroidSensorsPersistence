...
public class AccelerometerRepositoryTest
        extends RecordRepositoryTest<AccelerometerRecord, AccelerometerEntity> {
    ...
    public void setUp() throws Exception {
        ...
        sensorRecordRepository = new AccelerometerRepository(accelerometerEntityDao);
    }

    @Override
    protected AccelerometerRecord createSensorRecord() {
        return new AccelerometerRecord();
    }

    @Override
    protected AccelerometerEntity createSensorRecordEntity() {
        return new AccelerometerEntity();
    }
