...
import static com.ubikgs.androidsensors.persistence.testutils.TestEntityProvider.createWifiMeasurementsRecord;
 ...
 */
public class WifiMeasurementsRepositoryIntegrationTest extends RecordRepositoryIntegrationTest<WifiMeasurementsRecord> {

    @Inject WifiMeasurementsRepository wifiMeasurementsRepository;

    @Before
    public void setUp() throws Exception {
        DaggerTestBedComponent.create().inject(this);
        recordRepository = wifiMeasurementsRepository;
    }

    @Override
    protected WifiMeasurementsRecord createSensorRecord() {
        return createWifiMeasurementsRecord();
    }
