...
import static com.ubikgs.androidsensors.persistence.testutils.TestEntityProvider.createGyroscopeRecord;
 ...
 */
public class GyroscopeRecordRepositoryIntegrationTest extends SensorRecordRepositoryIntegrationTest<GyroscopeRecord> {

    @Inject GyroscopeRecordRepository gyroscopeRecordRepository;

    @Before
    public void setUp() throws Exception {
        DaggerTestBedComponent.create().inject(this);
        sensorRecordRepository = gyroscopeRecordRepository;
    }

    @Override
    protected GyroscopeRecord createSensorRecord() {
        return createGyroscopeRecord();
    }
