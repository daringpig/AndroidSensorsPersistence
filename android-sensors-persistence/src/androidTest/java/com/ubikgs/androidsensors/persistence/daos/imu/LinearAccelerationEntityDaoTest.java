 ...
 */
public class LinearAccelerationEntityDaoTest extends RecordEntityDaoIntegrationTest<LinearAccelerationEntity> {
    ...
    public void setUp() throws Exception {
        ...
        LinearAccelerationEntity entity1 = createLinearAccelerationRecordEntity();
        entity1.setForeignKey(registerForeignKeyUsage(0));
        registerTestEntity(entity1);

        LinearAccelerationEntity entity2 = createLinearAccelerationRecordEntity();
