 ...
 */
public class LocationEntityDaoIntegrationTest extends RecordEntityDaoIntegrationTest<LocationEntity> {
    ...
    public void setUp() throws Exception {
        ...
        LocationEntity entity1 = createLocationRecordEntity();
        entity1.setForeignKey(registerForeignKeyUsage(0));
        registerTestEntity(entity1);

        LocationEntity entity2 = createLocationRecordEntity();
