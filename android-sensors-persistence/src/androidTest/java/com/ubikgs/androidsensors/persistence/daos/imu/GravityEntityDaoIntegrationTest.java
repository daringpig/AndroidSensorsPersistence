 ...
 */
public class GravityEntityDaoIntegrationTest
        extends RecordEntityDaoIntegrationTest<GravityEntity> {
    ...
    public void setUp() throws Exception {
        ...
        GravityEntity entity1 = createGravityRecordEntity();
        entity1.setForeignKey(registerForeignKeyUsage(0));
        registerTestEntity(entity1);

        GravityEntity entity2 = createGravityRecordEntity();
