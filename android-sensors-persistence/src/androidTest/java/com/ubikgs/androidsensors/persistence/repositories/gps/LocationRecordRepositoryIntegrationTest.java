...
import static com.ubikgs.androidsensors.persistence.testutils.TestEntityProvider.createLocationRecord;
 ...
 */
public class LocationRecordRepositoryIntegrationTest extends SensorRecordRepositoryIntegrationTest<LocationRecord> {

    @Inject LocationRecordRepository locationRecordRepository;

    @Before
    public void setUp() throws Exception {
        DaggerTestBedComponent.create().inject(this);
        sensorRecordRepository = locationRecordRepository;
    }
