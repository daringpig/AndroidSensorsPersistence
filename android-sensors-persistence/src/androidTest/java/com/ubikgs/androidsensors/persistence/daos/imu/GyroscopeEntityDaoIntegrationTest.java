 ...
 */
public class GyroscopeEntityDaoIntegrationTest extends RecordEntityDaoIntegrationTest<GyroscopeEntity> {
    ...
    public void setUp() throws Exception {
        ...
        GyroscopeEntity entity1 = createGyroscopeRecordEntity();
        entity1.setForeignKey(registerForeignKeyUsage(0));
        registerTestEntity(entity1);

        GyroscopeEntity entity2 = createGyroscopeRecordEntity();
