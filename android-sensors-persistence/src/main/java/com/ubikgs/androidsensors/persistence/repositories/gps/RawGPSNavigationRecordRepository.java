...
public class RawGPSNavigationRecordRepository extends AbstractSensorRecordRepository<RawGPSNavigationRecord, RawGPSNavigationRecordEntity> {

    @Inject
    public RawGPSNavigationRecordRepository(RawGPSNavigationRecordEntityDao sensorRecordEntityDao) {
        super(sensorRecordEntityDao);
    }

    @Override
    protected RawGPSNavigationRecordEntity createFrom(RawGPSNavigationRecord sensorRecord) {
        return new RawGPSNavigationRecordEntity(sensorRecord);
    }
