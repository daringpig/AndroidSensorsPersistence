...
public class LinearAccelerationRecordEntity extends LinearAccelerationRecord implements SensorRecordEntity<LinearAccelerationRecord> {
    ...
    public LinearAccelerationRecordEntity(LinearAccelerationRecord linearAccelerationRecord) {
    ...
    public String toString() {
        return "LinearAccelerationRecordEntity{" +
                "uid=" + uid +
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LinearAccelerationRecordEntity)) return false;
        if (!super.equals(o)) return false;

        LinearAccelerationRecordEntity that = (LinearAccelerationRecordEntity) o;
