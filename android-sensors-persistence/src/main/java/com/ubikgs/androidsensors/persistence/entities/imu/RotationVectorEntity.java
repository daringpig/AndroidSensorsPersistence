...
public class RotationVectorEntity extends RotationVectorRecord implements RecordEntity<RotationVectorRecord> {
    ...
    public RotationVectorEntity() {
        super();
    }

    public RotationVectorEntity(RotationVectorRecord rotationVectorRecord) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RotationVectorEntity)) return false;
        if (!super.equals(o)) return false;

        RotationVectorEntity that = (RotationVectorEntity) o;
