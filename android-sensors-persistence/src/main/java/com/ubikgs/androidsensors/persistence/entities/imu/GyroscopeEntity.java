...
public class GyroscopeEntity extends GyroscopeRecord implements RecordEntity<GyroscopeRecord> {
    ...
    public GyroscopeEntity() {
        super();
    }

    public GyroscopeEntity(GyroscopeRecord gyroscopeRecord) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GyroscopeEntity)) return false;
        if (!super.equals(o)) return false;

        GyroscopeEntity that = (GyroscopeEntity) o;
