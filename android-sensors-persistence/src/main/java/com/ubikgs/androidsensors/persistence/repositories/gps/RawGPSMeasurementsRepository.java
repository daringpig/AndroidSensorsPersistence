...
public class RawGPSMeasurementsRepository extends AbstractRecordRepository<RawGPSMeasurementsRecord, RawGPSMeasurementsEntity> {

    @Inject
    public RawGPSMeasurementsRepository(RawGPSMeasurementsEntityDao sensorRecordEntityDao) {
        super(sensorRecordEntityDao);
    }

    @Override
    protected RawGPSMeasurementsEntity createFrom(RawGPSMeasurementsRecord sensorRecord) {
        return new RawGPSMeasurementsEntity(sensorRecord);
    }

    @Override
    protected RawGPSMeasurementsRecord transformIn(RawGPSMeasurementsEntity entity) {
