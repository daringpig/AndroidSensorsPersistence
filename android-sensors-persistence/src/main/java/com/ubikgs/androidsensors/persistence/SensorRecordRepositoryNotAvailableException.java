...
public class SensorRecordRepositoryNotAvailableException extends RuntimeException {

    public SensorRecordRepositoryNotAvailableException(Class<? extends SensorRecordRepository> type) {
        super(String.format("%s is not available on this device", type.getSimpleName()));
    }

    public SensorRecordRepositoryNotAvailableException(SensorType sensorType) {
