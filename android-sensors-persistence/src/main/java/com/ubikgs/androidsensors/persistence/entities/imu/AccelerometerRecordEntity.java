...
public class AccelerometerRecordEntity extends AccelerometerRecord implements SensorRecordEntity<AccelerometerRecord> {
    ...
    public AccelerometerRecordEntity() {
        super();
    }

    public AccelerometerRecordEntity(AccelerometerRecord accelerometerRecord) {
    ...
    public String toString() {
        return "AccelerometerRecordEntity{" +
                "uid=" + uid +
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AccelerometerRecordEntity)) return false;
        if (!super.equals(o)) return false;

        AccelerometerRecordEntity that = (AccelerometerRecordEntity) o;
