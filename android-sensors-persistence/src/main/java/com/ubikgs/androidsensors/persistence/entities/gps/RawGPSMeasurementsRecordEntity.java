...
public class RawGPSMeasurementsRecordEntity extends RawGPSMeasurementsRecord implements SensorRecordEntity<RawGPSMeasurementsRecord> {
    ...
    public RawGPSMeasurementsRecordEntity() {
        super();
    }
    ...
    public String toString() {
        return "RawGPSMeasurementsRecordEntity{" +
                "uid=" + uid +
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RawGPSMeasurementsRecordEntity)) return false;
        if (!super.equals(o)) return false;

        RawGPSMeasurementsRecordEntity that = (RawGPSMeasurementsRecordEntity) o;
