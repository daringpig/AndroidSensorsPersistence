...
public class GravityEntity extends GravityRecord implements RecordEntity<GravityRecord> {
    ...
    public GravityEntity(GravityRecord gravityRecord) {
        super(gravityRecord);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GravityEntity)) return false;
        if (!super.equals(o)) return false;

        GravityEntity that = (GravityEntity) o;
