...
public class MagneticFieldRepository extends AbstractRecordRepository<MagneticFieldRecord, MagneticFieldEntity> {

    @Inject
    public MagneticFieldRepository(MagneticFieldEntityDao sensorRecordEntityDao) {
        super(sensorRecordEntityDao);
    }

    @Override
    protected MagneticFieldEntity createFrom(MagneticFieldRecord sensorRecord) {
        return new MagneticFieldEntity(sensorRecord);
    }

    @Override
    protected MagneticFieldRecord transformIn(MagneticFieldEntity entity) {
