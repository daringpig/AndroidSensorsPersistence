...
public class MagneticFieldRecordEntity extends MagneticFieldRecord implements SensorRecordEntity {
    ...
    public MagneticFieldRecordEntity() {
        super();
    }
    ...
    public String toString() {
        return "MagneticFieldRecordEntity{" +
                "uid=" + uid +
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MagneticFieldRecordEntity)) return false;
        if (!super.equals(o)) return false;

        MagneticFieldRecordEntity that = (MagneticFieldRecordEntity) o;
