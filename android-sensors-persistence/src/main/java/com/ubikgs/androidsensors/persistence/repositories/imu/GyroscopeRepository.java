...
public class GyroscopeRepository extends AbstractRecordRepository<GyroscopeRecord, GyroscopeEntity> {

    @Inject
    public GyroscopeRepository(GyroscopeEntityDao sensorRecordEntityDao) {
        super(sensorRecordEntityDao);
    }

    @Override
    protected GyroscopeEntity createFrom(GyroscopeRecord sensorRecord) {
        return new GyroscopeEntity(sensorRecord);
    }

    @Override
    protected GyroscopeRecord transformIn(GyroscopeEntity entity) {
