...
public class LocationRepository extends AbstractRecordRepository<LocationRecord, LocationEntity> {

    @Inject
    public LocationRepository(LocationEntityDao sensorRecordEntityDao) {
        super(sensorRecordEntityDao);
    }

    @Override
    protected LocationEntity createFrom(LocationRecord sensorRecord) {
        return new LocationEntity(sensorRecord);
    }

    @Override
    protected LocationRecord transformIn(LocationEntity entity) {
