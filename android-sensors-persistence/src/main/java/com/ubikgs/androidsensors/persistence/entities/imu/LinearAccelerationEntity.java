...
public class LinearAccelerationEntity extends LinearAccelerationRecord implements RecordEntity<LinearAccelerationRecord> {
    ...
    public LinearAccelerationEntity() {
        super();
    }

    public LinearAccelerationEntity(LinearAccelerationRecord linearAccelerationRecord) {
    ...
    public String toString() {
        return "LinearAccelerationEntity{" +
                "uid=" + uid +
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LinearAccelerationEntity)) return false;
        if (!super.equals(o)) return false;

        LinearAccelerationEntity that = (LinearAccelerationEntity) o;
