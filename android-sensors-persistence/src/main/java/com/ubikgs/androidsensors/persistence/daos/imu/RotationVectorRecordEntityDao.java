...
public interface RotationVectorRecordEntityDao extends SensorRecordEntityDao<RotationVectorRecordEntity> {
    ...
    Single<List<RotationVectorRecordEntity>> findAllBy(long foreignKey, long offset, long limit);
    ...
    @Query("DELETE FROM RotationVectorRecordEntity WHERE foreignKey = :foreignKey")
