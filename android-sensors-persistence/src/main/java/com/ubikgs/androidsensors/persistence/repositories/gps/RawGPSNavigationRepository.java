...
public class RawGPSNavigationRepository extends AbstractRecordRepository<RawGPSNavigationRecord, RawGPSNavigationEntity> {

    @Inject
    public RawGPSNavigationRepository(RawGPSNavigationEntityDao sensorRecordEntityDao) {
        super(sensorRecordEntityDao);
    }

    @Override
    protected RawGPSNavigationEntity createFrom(RawGPSNavigationRecord sensorRecord) {
        return new RawGPSNavigationEntity(sensorRecord);
    }

    @Override
    protected RawGPSNavigationRecord transformIn(RawGPSNavigationEntity entity) {
