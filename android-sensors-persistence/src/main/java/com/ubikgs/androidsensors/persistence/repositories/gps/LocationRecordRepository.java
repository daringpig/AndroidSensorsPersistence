...
public class LocationRecordRepository extends AbstractSensorRecordRepository<LocationRecord, LocationRecordEntity> {

    @Inject
    public LocationRecordRepository(LocationRecordEntityDao sensorRecordEntityDao) {
        super(sensorRecordEntityDao);
    }

    @Override
    protected LocationRecordEntity createFrom(LocationRecord sensorRecord) {
        return new LocationRecordEntity(sensorRecord);
    }

    @Override
    protected LocationRecord transformIn(LocationRecordEntity entity) {
