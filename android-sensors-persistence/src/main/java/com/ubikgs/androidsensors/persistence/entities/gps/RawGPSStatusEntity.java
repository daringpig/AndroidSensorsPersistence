...
public class RawGPSStatusEntity extends RawGPSStatusRecord implements RecordEntity<RawGPSStatusRecord> {
    ...
    public RawGPSStatusEntity() {
        super();
    }

    public RawGPSStatusEntity(RawGPSStatusRecord rawGPSStatusRecord) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RawGPSStatusEntity)) return false;
        if (!super.equals(o)) return false;

        RawGPSStatusEntity that = (RawGPSStatusEntity) o;
