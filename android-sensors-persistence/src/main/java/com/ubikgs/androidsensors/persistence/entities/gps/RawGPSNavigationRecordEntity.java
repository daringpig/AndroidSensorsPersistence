...
public class RawGPSNavigationRecordEntity extends RawGPSNavigationRecord implements SensorRecordEntity<RawGPSNavigationRecord> {
    ...
    public RawGPSNavigationRecordEntity() {
        super();
    }
    ...
    public String toString() {
        return "RawGPSNavigationRecordEntity{" +
                "uid=" + uid +
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RawGPSNavigationRecordEntity)) return false;
        if (!super.equals(o)) return false;

        RawGPSNavigationRecordEntity that = (RawGPSNavigationRecordEntity) o;
